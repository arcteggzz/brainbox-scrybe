    ...
    <div className={styles.AudioControl}>
      ...
      <div className={styles.ControlButtons}>
        <div className={styles.RewindButton}>
          <svg width="17" height="10" viewBox="0 0 17 10" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M16.3996 9.625L9.47461 5L16.3996 0.375V9.625ZM7.52461 9.625L0.599609 5L7.52461 0.375V9.625ZM6.52461 7.75V2.25L2.39961 5L6.52461 7.75ZM15.3996 7.75V2.25L11.2746 5L15.3996 7.75Z" fill="#6A6A6A"/>
          </svg>
        </div>
        <div className={styles.PlayButton}>
          <svg width="9" height="12" viewBox="0 0 9 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0.5 11.1998V0.799805L8.65 5.9998L0.5 11.1998ZM1.5 9.3498L6.8 5.9998L1.5 2.6498V9.3498Z" fill="#6A6A6A"/>
          </svg>
        </div>
        <div className={styles.ForwardButton}>
          <svg width="17" height="10" viewBox="0 0 17 10" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0.599609 9.625V0.375L7.52461 5L0.599609 9.625ZM9.47461 9.625V0.375L16.3996 5L9.47461 9.625ZM1.59961 7.75L5.72461 5L1.59961 2.25V7.75ZM10.4746 7.75L14.5996 5L10.4746 2.25V7.75Z" fill="#6A6A6A"/>
          </svg>
        </div>
      </div>
      ...
      <div className={styles.AudioTimer}>
        ...
        <div className={styles.AudioSlider}>
          <div className={styles.AudioFull}></div>
