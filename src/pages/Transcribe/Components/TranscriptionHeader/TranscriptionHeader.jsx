import './TranscriptionHeader.scss';

function TranscriptionHeader() {
  return (
    <>
      <header className="">
        <input type="text" className="search-bar" placeholder='Search through transcripts'/>
